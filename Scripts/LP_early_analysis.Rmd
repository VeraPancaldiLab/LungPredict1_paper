...
compute.modules.relationship(network[[1]], pathways, "Pathways_Progeny-TFs_Modules", width = 10)
...
ht1 = Heatmap(t(scale(boruta_groups)), 
        border = T, cluster_rows = dend_row, cluster_columns = dend_column, 
...
pdf("Results/Heatmap_cells_groups_boruta", width = 25, height = 12)
draw(ht1, show_heatmap_legend = T, heatmap_legend_side = "left", annotation_legend_side = 'left')
dev.off()
```
